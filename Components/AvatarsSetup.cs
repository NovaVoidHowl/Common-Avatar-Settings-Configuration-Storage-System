...
namespace com.NovaVoidHowl.dev.unity.CASCSS
{
    ...
    public class AvatarsSetup : MonoBehaviour
    {
        ...
        public void AddVRChatComponent()
        {
            ...
            if(bodyMesh != null)
            {
                ...
                if(use_BlinkBlendshapes)
                {
                    ...
                    vrchatComponent.customEyeLookSettings.eyesLookingStraight = new VRC.SDK3.Avatars.Components.VRCAvatarDescriptor.CustomEyeLookSettings.EyeRotations();
                    vrchatComponent.customEyeLookSettings.eyesLookingUp = new VRC.SDK3.Avatars.Components.VRCAvatarDescriptor.CustomEyeLookSettings.EyeRotations();
                    vrchatComponent.customEyeLookSettings.eyesLookingDown = new VRC.SDK3.Avatars.Components.VRCAvatarDescriptor.CustomEyeLookSettings.EyeRotations();
                    vrchatComponent.customEyeLookSettings.eyesLookingLeft = new VRC.SDK3.Avatars.Components.VRCAvatarDescriptor.CustomEyeLookSettings.EyeRotations();
                    vrchatComponent.customEyeLookSettings.eyesLookingRight = new VRC.SDK3.Avatars.Components.VRCAvatarDescriptor.CustomEyeLookSettings.EyeRotations();
        ...
        #if VRC_SDK_VRCSDK3
        public Tuple<Vector3, Vector3>  ProcessEyeRotationData(VRC.SDK3.Avatars.Components.VRCAvatarDescriptor.CustomEyeLookSettings.EyeRotations eyeRotations)
        {
