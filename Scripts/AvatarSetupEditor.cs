...
namespace com.NovaVoidHowl.dev.unity.CASCSS
{
    ...
    public class AvatarsSetupEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            AvatarSetupScript.bodyMesh = (SkinnedMeshRenderer)EditorGUILayout.ObjectField("Face Visemes Mesh", AvatarSetupScript.bodyMesh, typeof(SkinnedMeshRenderer), true);
            ...
            if (AvatarSetupScript.bodyMesh != null)
            {
                ...
                AvatarSetupScript.use_BlinkBlendshapes = EditorGUILayout.Toggle("Use Blink Blendshapes", AvatarSetupScript.use_BlinkBlendshapes);
                EditorGUI.EndDisabledGroup();
                if (AvatarSetupScript.use_BlinkBlendshapes)
                {
                    
                    RenderFoldoutSection("Chillout VR Specific", ref AvatarSetupScript.cvrBlinkShowSection, () =>
                    {
                        renderCVRBlinkLayers();
                    });

                    RenderFoldoutSection("VRChat Specific", ref AvatarSetupScript.vrcBlinkShowSection, () =>
                    {
                ...
                RenderFoldoutSection("Eye Look Settings", ref AvatarSetupScript.eyeLookShowSection, () =>
                {
                    renderEyeBoneConfig();
                ...
                if (AvatarSetupScript.use_visemes)
                {
                    if (AvatarSetupScript.bodyMesh != null)
                    {
                        RenderFoldoutSection("Viseme List", ref AvatarSetupScript.VisemesShowSection, () =>
                        {
                ...
                EditorGUI.EndDisabledGroup();
                RenderFoldoutSection("VRChat Specific", ref AvatarSetupScript.vrcLayerShowSection, () =>
                {
                    renderVRCLayers();
                });
        ...
        private void renderEyeLookRotationConfig()
        {
            ...
            AvatarSetupScript.perEyeRotations = EditorGUILayout.Toggle("Custom Limits for each eye", AvatarSetupScript.perEyeRotations);

            EditorGUILayout.LabelField($"{(AvatarSetupScript.perEyeRotations ? "Left" : "")}Eye Angle Limits:", EditorStyles.boldLabel);
        ...
        private void renderEyeBoneConfig()
        {
            ...
            AvatarSetupScript.leftEyeBone = (Transform)EditorGUILayout.ObjectField("Left Eye Bone", AvatarSetupScript.leftEyeBone, typeof(Transform), true);
            AvatarSetupScript.rightEyeBone = (Transform)EditorGUILayout.ObjectField("Right Eye Bone", AvatarSetupScript.rightEyeBone, typeof(Transform), true);
            EditorGUI.EndDisabledGroup();
        }
        ...
        {
            EditorGUI.BeginDisabledGroup(AvatarSetupScript.GetIsConfigured()); // if configured disable the fields
            AvatarSetupScript.vrcAction = (RuntimeAnimatorController) EditorGUILayout.ObjectField("Action", AvatarSetupScript.vrcAction, typeof(RuntimeAnimatorController), true);
            AvatarSetupScript.vrcBase = (RuntimeAnimatorController) EditorGUILayout.ObjectField("Base", AvatarSetupScript.vrcBase, typeof(RuntimeAnimatorController), true);
            AvatarSetupScript.vrcGesture = (RuntimeAnimatorController) EditorGUILayout.ObjectField("Gesture", AvatarSetupScript.vrcGesture, typeof(RuntimeAnimatorController), true);
            AvatarSetupScript.vrcAdditive = (RuntimeAnimatorController) EditorGUILayout.ObjectField("Additive", AvatarSetupScript.vrcAdditive, typeof(RuntimeAnimatorController), true);
            AvatarSetupScript.vrcFX = (RuntimeAnimatorController) EditorGUILayout.ObjectField("FX", AvatarSetupScript.vrcFX, typeof(RuntimeAnimatorController), true);
            AvatarSetupScript.vrcSitting = (RuntimeAnimatorController) EditorGUILayout.ObjectField("Sitting", AvatarSetupScript.vrcSitting, typeof(RuntimeAnimatorController), true);
            AvatarSetupScript.vrcIKPose = (RuntimeAnimatorController) EditorGUILayout.ObjectField("IKPose", AvatarSetupScript.vrcIKPose, typeof(RuntimeAnimatorController), true);
            AvatarSetupScript.vrcTPose = (RuntimeAnimatorController) EditorGUILayout.ObjectField("TPose", AvatarSetupScript.vrcTPose, typeof(RuntimeAnimatorController), true);
            EditorGUI.EndDisabledGroup();
        }
        ...
        {
            Rect foldoutRect = GUILayoutUtility.GetRect(GUIContent.none, EditorStyles.helpBox, GUILayout.ExpandWidth(true), GUILayout.Height(30f));
            ...
            GUI.DrawTexture(new Rect(foldoutRect.x + 4f, foldoutRect.y + 7f, 16f, 16f), (showSection ? EditorGUIUtility.IconContent("IN Foldout on").image : EditorGUIUtility.IconContent("IN Foldout").image));
        ...
        private void RenderSetupButtonsSection(AvatarsSetup AvatarSetupScript, int avatarComponentsFound)
        {
            ...
            EditorGUI.BeginDisabledGroup(!IsVRC_SDK_VRCSDK3Exists()  || !setupButtonsEnabled || AvatarSetupScript.GetIsConfigured());
        ...
        private void renderAvatarMenuSection(AvatarsSetup AvatarSetupScript)
        {
            ...
            AvatarSetupScript.use_AvatarMenu = EditorGUILayout.Toggle("Enable Custom Avatar Menu", AvatarSetupScript.use_AvatarMenu);
            EditorGUI.EndDisabledGroup();
            if (AvatarSetupScript.use_AvatarMenu)
            {

                RenderFoldoutSection("VRChat Specific", ref AvatarSetupScript.vrcMenuShowSection, () =>
                {
                    EditorGUI.BeginDisabledGroup(AvatarSetupScript.GetIsConfigured()); // if configured disable the fields
                    AvatarSetupScript.vrcBaseMenu = EditorGUILayout.ObjectField("Avatar Menu Path", AvatarSetupScript.vrcBaseMenu, typeof(UnityEngine.Object), false);
                    AvatarSetupScript.vrcParameters = EditorGUILayout.ObjectField("Avatar Parameters Path", AvatarSetupScript.vrcParameters, typeof(UnityEngine.Object), false );
                    EditorGUI.EndDisabledGroup();
                });
            }
        ...
        private void renderCredits()
        {
            ...
            EditorGUILayout.BeginHorizontal();
            GUILayout.FlexibleSpace();
            EditorGUILayout.LabelField("Powered By NVH's Common Avatar Settings Configuration & Storage System", GUILayout.Width(440) );
            EditorGUILayout.EndHorizontal();
            EditorGUILayout.BeginHorizontal();
            GUILayout.FlexibleSpace();
